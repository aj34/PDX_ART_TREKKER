...
ViewAssembler.prototype.galleryView = function(startIndex, endIndex, items, showRefreshButton, showMoreImagesButton) {
    ...
    for (var i=parseInt(startIndex); i< parseInt(endIndex); i++) {
        var art = items[i];
        markupString += "<a href='javascript:showArtDetailsFromMapClick(" + art.attributes.record_id +");'>" +
                        "<img id='galleryThumbnail' class='img-polaroid' src='" + art.attributes.image_url +"'/></a>"
    }
